...
<a href = 'AddToLibrary'>Add Books</a> | <a href = 'ReturnBook.jsp'>Return A Book</a>
...
<tr>
	...
	<c:if test="${b.copies > 0}">
		<td><a href = 'Borrow.jsp?bookID=<c:out value="${b.id}" />&title=<c:out value="${b.title} " />'>Borrow</a> </td></tr>
	</c:if>
</tr>
</c:forEach>
</table>
